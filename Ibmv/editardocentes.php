...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT * FROM registrodocentes WHERE id = $id";  // Corregido aquí
...
if (isset($_POST['editar'])) {
    ...
    $sql = "UPDATE registrodocentes SET Nombre =' $Nombre', Apellidop='$Apellidop', Apellidom='$Apellidom',  Asignatura ='$Asignatura',  correo ='$correo',  Telefono ='$Telefono' WHERE id=$id";

    if ($conn->query($sql) === TRUE) {
        echo "Usuario actualizado correctamente";
        header("Location: basedocent.php"); // Redirige a la lista de usuarios
    } else {
...
<body>
    ...
    <div class="container">
        <form method="POST" action="">
            ...
            <input type="text" id="Asignatura" name="Asignatura" value="<?php echo $row['Asignatura']; ?>" required><br><br>

            <label for="correo">Correo</label>
            <input type="email" id="correo" name="correo" value="<?php echo $row['correo']; ?>" required><br><br>

            <label for="Telefono">Telefono</label>
            <input type="number" id="Telefono" name="Telefono" value="<?php echo $row['Telefono']; ?>" required><br><br>
